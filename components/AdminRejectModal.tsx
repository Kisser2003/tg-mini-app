...
export const ADMIN_REJECT_PRESETS = [
  {
    ...
    label: "Caps Lock",
    message:
      "Нарушение типографики: избегайте длинных фрагментов в ВЕРХНЕМ РЕГИСТРЕ в названиях и именах."
  },
  {
    key: "quality",
    label: "Low Quality",
    message: "Низкое качество аудио: шум, клиппинг или несоответствие заявленному материалу."
  },
  {
    key: "copyright",
    label: "Copyright",
    message: "Подозрение на нарушение авторских прав или отсутствие прав на распространение."
  },
  {
    key: "artwork",
    label: "Bad Artwork",
    message: "Обложка не соответствует требованиям: разрешение, читаемость текста или оформление."
  }
] as const;
